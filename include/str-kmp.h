...
static bool
knuth_morris_pratt (const char16_t *haystack,
		    const char16_t *needle, size_t needle_len,
		    const char16_t **resultp)
{
  size_t m = needle_len;
     ...
     table[0] remains uninitialized.  */
  {
	...
	char16_t b = CANON_ELEMENT (needle[i - 1]);
  ...
  {
    size_t j;
    const char16_t *rhaystack;
    const char16_t *phaystack;
