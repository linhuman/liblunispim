...
#define	CICACHE_FILE_NAME			"/wordlib/ci_cache.dat"
...
//装载、保存词Cache数据
extern int LoadCiCacheData(const char *ci_cache_file_name);
extern int SaveCiCacheData(const char *ci_cache_file_name);
extern int FreeCiCacheData();
//extern int LoadNewWordTable();
//extern int SaveNewWordTable();
//extern void FreeNewWordTable();

extern int UpgradeWordLibFromV5ToV6(const char *);
