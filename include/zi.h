...
#define	ZICACHE_FILE_NAME	"/zi/hz_cache.dat"	//汉字Cache文件名称
#define	HZDATA_FILE_NAME	"/zi/hzpy.dat"		//汉字数据文件名称
#define HZBH_FILE_NAME		"/zi/hzbh.dat"		//汉字笔划数据文件名称
#define	TOPZI_FILE_NAME		"/ini/固顶字.ini"	//置顶字定义文件名称
#define	HZJF_FILE_NAME		"/zi/hzjf.dat"		//汉字简繁对照表数据文件名称
...
//装载、释放置顶字文件
extern int LoadTopZiData(const char *name);
extern int FreeTopZiData();

//装载、保存、释放汉字Cache数据
extern int LoadHZData(const char *hz_data_name);
extern int FreeHZData();
extern int LoadZiCacheData(const char *zi_cache_name);
extern int FreeZiCacheData(const char *zi_cache_name);
extern int SaveZiCacheData(const char *zi_cache_name);
...
//装载、释放笔划数据文件
extern int LoadBHData(const char *file_name);
