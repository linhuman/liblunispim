...
int LoadTopZiResource()
{
    ...
    GetFileFullName(TOPZI_FILE_NAME, name);
...
int LoadZiCacheResource()
{
    ...
    GetFileFullName(ZICACHE_FILE_NAME, name);
...
int LoadHZDataResource()
{
    ...
    GetFileFullName(HZDATA_FILE_NAME, name);
	if (LoadHZData(name))
		return 1;
...
int LoadCiCacheResource()
{
    ...
    GetFileFullName(CICACHE_FILE_NAME, name);
...
int LoadBigramResource()
{
    ...
    GetFileFullName(BIGRAM_FILE_NAME, name);
...
int LoadSPResource()
{
    ...
    GetFileFullName(SP_INI_FILE_NAME, name);
...
int LoadFontMapResource()
{
    ...
    GetFileFullName(FONTMAP_FILE_NAME, name);
...
int LoadEnglishResource()
{
    ...
    GetFileFullName(ENGLISH_LIB_FILE_NAME, name);
...
int LoadEnglishTransResource()
{
    ...
    GetFileFullName(ENGLISH_TRANS_FILE_NAME, name);
...
int LoadBHResource()
{
    ...
    GetFileFullName(HZBH_FILE_NAME, name);
	if(LoadBHData(name))
		return 1;
